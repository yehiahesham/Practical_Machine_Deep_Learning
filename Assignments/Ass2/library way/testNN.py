...
neuron2=neuron(sigmod,d_sigmod,weights=testing_weights2,biase=testing_biase)
neuron3=neuron(sigmod,d_sigmod,weights=testing_weights3,biase=testing_biase)
neuron4=neuron(sigmod,d_sigmod,weights=testing_weights4,biase=testing_biase)
neuron5=neuron(sigmod,d_sigmod,weights=testing_weights5,biase=testing_biase)
