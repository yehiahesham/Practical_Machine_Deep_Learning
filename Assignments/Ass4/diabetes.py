...
def loadData(path):     #loads diabetes csv file and returns pima-indians-diabetes & True labels
    ...
    return  X_train, Y_train, cov, feature_names
...
X_train, Y_train, cov, feature_names = loadData('./data/pima-indians-diabetes.csv')

eigenvalues, eigenvectors = np.linalg.eig(cov);

print 'eigenvalues.shape is',eigenvalues.shape
print 'eigenvectors.shape is ',eigenvectors.shape
